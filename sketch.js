...
function setup() {
  // 1 - AUMENTAR O TAMANHANHO DA JANELA DA AREA DE JOGO
  createCanvas(windowWidth, windowHeight);
  
  //2- COLOCAR A ALTURA DO TREX - "HEIGHT"
 ...
 trex.addAnimation("collided", trexcolide);
  ...
  //3 - COLOCAR "WIDTH/2, HEIGHT -10, WIDHT,125"
...
if (estadojogo===jogar)  {
  ...
  //4 - TOUCHES NO TREX SUBISTITUINDO A TECLA "SPACE"
